...
export interface ActionItem {
  id: number;
  // 'critical' will be red/magenta, 'warning' will be yellow/gold
  type: 'critical' | 'warning';
  title: string;
  description: string;
  savingsAmount: string; // e.g., "AED 50/mo"
  actionButtonText: string; // e.g., "Optimize"
}
...
export class EnergyAnalyticsComponent implements OnInit {
  ...
  // 2. Mock data matching the image content
  actions: ActionItem[] = [
    {
      id: 1,
      type: 'critical', // Triggers red styling
      title: 'High AC Usage Detected',
      description:
        'Living Room AC is set to 22°C while outside is 28°C. Increasing to 24°C will save approx. AED 50/month.',
      savingsAmount: 'AED 50/mo',
      actionButtonText: 'Optimize',
    },
    {
      id: 2,
      type: 'warning', // Triggers yellow styling
      title: 'Idle Device Detected',
      description:
        'Guest Room lights have been on for 2 hours with no motion detected.',
      savingsAmount: 'AED 8/mo',
